...
class EventSelectionWindow(QMainWindow):
	...
	def init_window(self):
		...
		self.labels = list()
		with open(r'E:\soccernettstmaster\Annotation\actions\config\classes.txt') as file:
			for cnt, line in enumerate(file):
				self.labels.append(line.rstrip())

		# Read the available second labels
		self.second_labels = list()
		with open(r'E:\soccernettstmaster\Annotation\actions\config\second_classes.txt') as file:
			for cnt, line in enumerate(file):
				self.second_labels.append(line.rstrip())

		# Read the available third labels
		self.third_labels = list()
		with open(r'E:\soccernettstmaster\Annotation\actions\config\third_classes.txt') as file:
			for cnt, line in enumerate(file):
