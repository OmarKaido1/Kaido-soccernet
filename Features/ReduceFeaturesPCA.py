...
if __name__ == "__main__":
    ...
    parser.add_argument('--soccernet_dirpath', type=str, default="E:\E\soccernet\dataset",
                        help="Path for SoccerNet directory [D:\\soccernet\dataset]")
    parser.add_argument('--features', type=str, default="ResNET_TF2.npy",
                        help="features to perform PCA on [default:ResNET_TF2.npy]")    
    parser.add_argument('--features_PCA', type=str, default="ResNET_TF2_PCA512.npy",help="name of reduced features [default:ResNET_TF2_PCA512.npy]")
    parser.add_argument('--pca_file', type=str, default="pca_512_TF2.pkl",help="pickle for PCA [default:pca_512_TF2.pkl]")
    parser.add_argument('--scaler_file', type=str, default="average_512_TF2.pkl",help="pickle for average [default:average_512_TF2.pkl]")
    parser.add_argument('--dim_reduction', type=int, default=512,help="dimension reduction [default:512]")
    parser.add_argument('--overwrite', action="store_true",help="Overwrite the features? [default:False]")
