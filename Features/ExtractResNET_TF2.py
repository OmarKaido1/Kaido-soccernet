...
class FeatureExtractor():
    def __init__(self, rootFolder,
        ...
        # create pretrained encoder (here ResNet152, pre-trained on ImageNet)
                ...
                print(f"Error loading ResNet152 model: {e}")
                return
...
if __name__ == "__main__":
    ...
    parser.add_argument('--soccernet_dirpath', type=str, default=r"E:\E\soccernet\dataset",
                        help="Path for SoccerNet directory [E:\E\soccernet\dataset]")
